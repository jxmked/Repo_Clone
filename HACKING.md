...
hidden if the `project_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `project_DEVELOPER_MODE` to the configure
...
Runs the executable target `project_exe`.
